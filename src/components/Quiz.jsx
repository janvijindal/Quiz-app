      ...
      <div className="md:w-9/12 w-[90%] flex md:flex-row flex-col mx-auto">
        ...
        <div className="md:w-[70%] w-full">
          <div>
            {questions.map((question, index) => (
              ...
              >
                <p className="flex items-center rounded text-xs p-2 cursor-pointer">
                  <span className="h-8 w-8 bg-[#fc224a] rounded-full flex justify-center items-center text-white mr-3">
                    {index + 1}
                  </span>
            ...
            <button onClick={handleSubmit} className="bg-[#fc224a] px-6 py-2 text-white rounded">
              Submit Quiz
            </button>
          </div>
        </div>
        ...
        <div className="md:w-[30%] w-full p-4">
          {showResult && (
            <div>
              ...
              <div className="h-[220px] w-[220px] mx-auto mt-8 flex flex-col justify-center items-center border-2 rounded-tr-[50%] rounded-bl-[50%]">
              <h3 className={`text-xl ${status === "Passed" ? "text-green-800" : "text-blue-500"}`}>
              {status}
            </h3>
              ...
              <button
                onClick={restartQuiz}
                className="bg-[#fc224a] text-white w-full py-2 rounded mt-16"
              >
                Restart
              </button>
            </div>
