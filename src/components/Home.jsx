      ...
      <div className="md:w-1/2 w-full">
        ...
        <div className="flex items-center">
          <button
            ...
            className={`bg-[#fc224a] px-6 py-2 text-white rounded ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
            id="startQuiz"
            type="button"
            disabled={loading}
          >
          ...
          <button
            className="px-6 py-2 text-[#fc224a] hover:bg-[#ee5e5e] hover:text-white rounded inline-flex ml-3 transition-all duration-300"
            type="button"
          >
            <svg
